...
async def seed():
    async with async_session() as db:
        ...
        # ── 21. Notifications ──
        notifications = [
            Notification(user_id=1, title="Payment Certificate Approved", message="PC-GAL-003 has been approved", type="success", is_read=False, link="/engineering/payment-certificates"),
            Notification(user_id=1, title="HSR Progress Update", message="HSR earthworks reached 60%", type="info", is_read=False, link="/engineering/projects"),
            Notification(user_id=1, title="New IPC Ready", message="IPC-SP-001 is ready for review", type="warning", is_read=False, link="/engineering/ipc"),
            Notification(user_id=1, title="Safety Report Due", message="Monthly HSE report for Sokhna Port is due", type="info", is_read=False, link="/engineering/daily-reports"),
        ]
