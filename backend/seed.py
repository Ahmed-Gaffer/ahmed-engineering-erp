...
async def seed():
    ...
    async with async_session() as db:
        ...
        ipc1 = IPCHeader(project_id=p1.id, contract_id=ctr1.id, ipc_number="IPC-001", ipc_period=1, start_date=date(2025, 4, 1), end_date=date(2025, 6, 30), status="paid", total_amount=Decimal("120000"), retention_amount=Decimal("6000"), net_amount=Decimal("114000"))
        ipc2 = IPCHeader(project_id=p1.id, contract_id=ctr1.id, ipc_number="IPC-002", ipc_period=2, start_date=date(2025, 7, 1), end_date=date(2025, 9, 30), status="approved", total_amount=Decimal("180000"), retention_amount=Decimal("9000"), net_amount=Decimal("171000"))
