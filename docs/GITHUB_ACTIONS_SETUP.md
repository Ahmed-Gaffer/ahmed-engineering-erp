...
- Your Space: `https://huggingface.co/spaces/Tablets/engineering-erp`
- Space repo name: `Tablets/engineering-erp`
...
| `HF_SPACE_REPO` | `Tablets/engineering-erp` | Your HF Space repository name |
...
1. Go to `https://huggingface.co/spaces/Tablets/engineering-erp`
...
3. Check Space logs: `https://huggingface.co/spaces/Tablets/engineering-erp/logs`

### Manual Deploy (Emergency)
```bash
# Set environment variables
export HF_TOKEN="your_hf_token"
export HF_SPACE_REPO="Tablets/engineering-erp"
...
- [ ] HF_SPACE_REPO added to GitHub Secrets (`Tablets/engineering-erp`)
- [ ] GitHub Actions workflow enabled
- [ ] First auto-deploy triggered and completed
- [ ] Space accessible at `https://huggingface.co/spaces/Tablets/engineering-erp`
