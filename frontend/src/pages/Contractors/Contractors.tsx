...
const columns = [
  { field: 'code', headerName: 'code', width: 100, linkTo: '/engineering/contractors' },
...
export default function Contractors() {
  return <EntityPage service={contractorsService} columns={columns} fields={fields} title="contractors" icon={<People />} accentColor="#14b8a6" />;
}
