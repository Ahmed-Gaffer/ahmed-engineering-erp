...
export default function PaymentCertificates() {
  ...
  return <EntityPage service={paymentCertificatesService} columns={columns} fields={fields} title="paymentCertificates" icon={<Receipt />} accentColor={theme.palette.secondary.main} />;
}
