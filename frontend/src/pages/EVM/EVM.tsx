                  ...
                  <CardContent>
                    ...
                    <EChart
                      ...
                      option={{
                        ...
                        xAxis: { type: 'category', data: sCurveData.map(d => d.name) },
                        yAxis: { type: 'value', axisLabel: { formatter: (v) => formatNumber(v) } },
                        series: [
                          { type: 'line', name: 'PV (Planned)', data: sCurveData.map(d => d.planned), smooth: true, symbol: 'circle', symbolSize: 8 },
                          { type: 'line', name: 'EV (Earned)', data: sCurveData.map(d => d.earned), smooth: true, symbol: 'circle', symbolSize: 8 },
                          { type: 'line', name: 'AC (Actual)', data: sCurveData.map(d => d.actual), smooth: true, symbol: 'circle', symbolSize: 8 },
                        ],
                        legend: {},
                      }}
                    />
