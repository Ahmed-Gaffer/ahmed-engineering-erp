...
const permitTypeColors = {
  ...
  confined_space: { bg: 'rgba(139,92,246,0.15)', color: 'secondary.main' },
        ...
        <Stack direction="row" spacing={0.5}>
          ...
          {params.row.status === 'approved' && (
            <Tooltip title={t('issue')}>
              <IconButton size="small" onClick={() => handleAction(params.row.id, 'issue')} sx={{ color: theme.palette.secondary.main, bgcolor: `${theme.palette.secondary.main}15` }}>
                <Send fontSize="small" />
              </IconButton>
            </Tooltip>
          )}
