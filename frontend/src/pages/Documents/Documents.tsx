...
const columns = [
  ...
  { field: 'project_id', headerName: 'project', type: 'number', width: 80, linkTo: (row: any) => `/engineering/projects/${row.project_id}` },
...
export default function Documents() {
  ...
  return <EntityPage service={documentsService} columns={columns} fields={fields} title="documents" icon={<Description />} accentColor={theme.palette.secondary.main} />;
}
