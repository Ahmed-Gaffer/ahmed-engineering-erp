...
import { Add, Edit, Delete, CheckCircle, PictureAsPdf, EventNote } from '@mui/icons-material';
...
export default function MeetingMinutes() {
  ...
  const columns = [
    ...
    { field: 'meeting_date', headerName: t('meetingDate'), width: 110, type: 'date',
      ...
      renderCell: (params: any) => <Typography variant="body2">{formatDate(params.value)}</Typography>,
    },
    { field: 'meeting_type', headerName: t('meetingType'), width: 110,
      renderCell: (params: any) => <Chip label={t(params.value)} size="small" variant="outlined" />,
    },
      ...
      renderCell: (params: any) => (
        <Stack direction="row" spacing={0.5}>
          ...
          <Tooltip title={t('downloadPdf')}>
            <IconButton size="small" onClick={() => downloadPdf(params.row.id)} sx={{ color: theme.palette.secondary.main, bgcolor: `${theme.palette.secondary.main}15` }}>
